...
#' The definition of two parameter log-logistic model(2PLM) function.
#' The log-logistic models are the most used dose-response models. 
#' @param alp the parameter of 2PLM, 2-dim
#' @param x the independent variable
#' @param logarg to choose the parameterzation form of 2PLM
#' @export
fun.2plm<-function(alp,x, logarg=1)
{
  b=alp[1]; e=alp[2]
...
#' The definition of three parameter log-logistic model(3PLM) function.
#' @param alp the parameter of 3PLM, 3-dim
#' @param x the independent variable
#' @param logarg to choose the parameterzation form
#' @export

fun.3plm<-function(alp,x, logarg=1)
{
...
#' The definition of four parameter log-logistic model(4PLM) function.
#' @param alp the parameter of 4PLM, 4-dim
#' @param x the independent variable
#' @param logarg to choose the parameterzation form
#' @export

fun.4plm<-function(alp,x, logarg=1)
{
...
#' The definition of five parameter log-logistic model(5PLM) function.
#' @param alp the parameter of 5PLM, 5-dim
#' @param x the independent variable
#' @param logarg to choose the parameterzation form
#' @export

fun.5plm<-function(alp,x, logarg=1)
{
